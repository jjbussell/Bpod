...
LoadSerialMessages(DIOmodule, {buzzer1, buzzer2,...
    ...
    [22 1],[22 0],[23 1], [23 0],[houseLight 1],[houseLight 0]});
...
sma = AddState(sma, 'Name', 'OdorALeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftOdorOff'},...
...
sma = AddState(sma, 'Name', 'OdorDLeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftOdorOff'},...
    'OutputActions', [{DIOmodule,SideDIOmsg1}, RunOdor(LeftSideOdor,1)]);
sma = AddState(sma, 'Name', 'LeftOdorOff', ...
    'Timer',0,...
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftPortCheck','Port1Out','TimeoutGraceLeft'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'LeftNotPresent', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup','LeavingTimeout'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'OdorARight', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RightOdorOff'},...
...
sma = AddState(sma, 'Name', 'OdorDRight', ...
    ...
    'StateChangeConditions', {'Tup','RightOdorOff'},...
    'OutputActions', [{DIOmodule,SideDIOmsg1}, RunOdor(RightSideOdor,2)]);
sma = AddState(sma, 'Name', 'RightOdorOff', ...
    'Timer',0,...
...
sma = AddState(sma, 'Name', 'RewardDelayRight', ...
    'Timer', S.GUI.RewardDelay,...
    'StateChangeConditions', {'Tup','RightPortCheck','Port3Out','TimeoutGraceRight'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'LeavingTimeout', ...
    ...
    'OutputActions', {DIOmodule, 17});

sma = AddState(sma, 'Name', 'EndTrial', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', '>exit'},...
    'OutputActions', {'GlobalTimerCancel', 2, DIOmodule,18});
...
function state_colors = getStateColors(thisInfoSide)
    if thisInfoSide == 0
        state_colors = struct( ...
            ...
            'TimeoutGraceLeft',[0 0 0],...
            'TimeoutGraceRight',[0 0 0],...
