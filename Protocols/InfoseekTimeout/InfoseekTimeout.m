...
sma = AddState(sma, 'Name', 'WaitForOdorLeft', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorState,'Condition7',SideOdorState,'Port1Out','TimeoutGraceLeft','Condition4','TimeoutGraceLeft'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'OdorALeft', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RewardDelayLeft','Condition4','TimeoutGraceLeft','Port1Out','TimeoutGraceLeft'},...
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftPortCheck','Condition4','TimeoutGraceLeft','Port1Out','TimeoutGraceLeft'},...
...
sma = AddState(sma, 'Name', 'WaitForOdorRight', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorState,'Condition7',SideOdorState,'Port3Out','TimeoutGraceRight','Condition6','TimeoutGraceRight'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'OdorARight', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RewardDelayRight','Condition6','TimeoutGraceRight','Port3Out','TimeoutGraceRight'},...
...
sma = AddState(sma, 'Name', 'RewardDelayRight', ...
    'Timer', S.GUI.RewardDelay,...
    'StateChangeConditions', {'Tup','RightPortCheck','Condition6','TimeoutGraceRight','Port3Out','TimeoutGraceRight'},...
...
sma = AddState(sma, 'Name', 'TimeoutGraceLeft', ...
    'Timer', gracePeriod,...
    'StateChangeConditions', {'Tup', 'LeavingTimeout','Port1In', '>back'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'TimeoutGraceRight', ...
    'Timer', gracePeriod,...
    'StateChangeConditions', {'Tup', 'LeavingTimeout','Port3In', '>back'},...
    'OutputActions', {});
