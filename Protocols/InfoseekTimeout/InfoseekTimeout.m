...
sma = AddState(sma, 'Name', 'WaitForOdorLeft', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorState,'Condition7',SideOdorState,'Port1Out','LeavingTimeout','Condition4','LeavingTimeout'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'OdorALeft', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RewardDelayLeft','Condition4','LeavingTimeout','Port1Out','LeavingTimeout'},...
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftPortCheck','Condition4','LeavingTimeout','Port1Out','LeavingTimeout'},...
