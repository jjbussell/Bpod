...
sma = AddState(sma, 'Name', 'WaitForOdorLeft', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorStateLeft,'Condition7',SideOdorStateLeft,'Port1Out','TimeoutOdor','Condition4','TimeoutOdor'},...
    'OutputActions', closeDoors(1));
sma = AddState(sma, 'Name', 'OdorALeft', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','OpenCenterLeft',,'Port1Out','TimeoutOdor','Condition4','TimeoutOdor'},...
...
sma = AddState(sma, 'Name', 'WaitForOdorRight', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorStateRight,'Condition7',SideOdorStateRight,'Port3Out','TimeoutOdor','Condition6','TimeoutOdor'},...
    'OutputActions', closeDoors(1)); %closeDoors(1)
sma = AddState(sma, 'Name', 'OdorARight', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','OpenCenterRight',,'Port3Out','TimeoutOdor','Condition6','TimeoutOdor'},...
