...
sma = AddState(sma, 'Name', 'StartTrial', ...
    ...
    'OutputActions', {DIOmodule,5,DIOmodule,4,DIOmodule,8});
...
sma = AddState(sma, 'Name', 'GoCue', ...
    ...
    'OutputActions', [{'GlobalTimerTrig', 1,DIOmodule,2},doorOpen]);
...
sma = AddState(sma, 'Name', 'DoorOpenGraceLeft', ...
    ...
    'OutputActions', {DIOmodule,1,DIOmodule,3});
...
sma = AddState(sma, 'Name', 'DoorOpenGraceRight', ...
    ...
    'OutputActions', {DIOmodule,1,DIOmodule,7});
