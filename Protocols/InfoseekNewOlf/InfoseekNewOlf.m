...
sma = AddState(sma, 'Name', 'CenterOdorPreload',...
    ...
    'OutputActions',[{'DIOLicks1',3},PreloadOdor(ThisCenterOdor)]); %Preloadcenter odor
...
sma = AddState(sma, 'Name', 'PreloadOdorLeft', ...
    ...
    'OutputActions', [{'DIOLicks1',5}, PreloadOdor(LeftSideOdor)]); % preload left side odor
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'OutputActions', [{'DIOLicks1',6},PresentOdor(1),PreloadOdor(LeftSideOdor)]);
...
sma = AddState(sma, 'Name', 'PreloadOdorRight', ...
    ...
    'OutputActions', [{'DIOLicks1',7},PreloadOdor(RightSideOdor)]); % preload left side odor
