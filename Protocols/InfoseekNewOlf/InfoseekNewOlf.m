...
sma = SetGlobalTimer(sma,'TimerID',5,'Duration',S.GUI.OdorDelay+0.05-OdorHeadstart,'OnsetDelay',0,...
   'Channel','SoftCode','OnMessage', 0, 'OffMessage', 0, 'Loop', 0, 'SendEvents', 1);
...
sma = AddState(sma, 'Name', 'CenterOdor', ...
    ...
    'OutputActions',[{DIOmodule,3,'PWM2',50,'GlobalTimerTrig',8},PresentOdor(0)]);
sma = AddState(sma, 'Name', 'CenterOdorOff',...
    'Timer', 0,...
    'StateChangeConditions', {'Tup','WaitForCenter'},...
    'OutputActions', [{DIOmodule,4,'PWM2',50},PresentOdor(0)]);
...
sma = AddState(sma, 'Name', 'GoCue', ...
    ...
    'OutputActions', {'GlobalTimerTrig', 1,DIOmodule,2,'GlobalTimerTrig',8});
...
sma = AddState(sma, 'Name', 'OdorALeft', ...
    ...
    'OutputActions', [{DIOmodule,5,'GlobalTimerTrig',8},PresentOdor(1)]);
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'OutputActions', [{DIOmodule,6},PresentOdor(1),PreloadOdor(LeftSideOdor,1)]);
...
sma = AddState(sma, 'Name', 'OdorARight', ...
    ...
    'OutputActions', [{DIOmodule,5,'GlobalTimerTrig',8}, PresentOdor(2)]);
...
sma = AddState(sma, 'Name', 'RewardDelayRight', ...
    ...
    'OutputActions', [{DIOmodule,6},PresentOdor(2),PreloadOdor(RightSideOdor,2)]);
