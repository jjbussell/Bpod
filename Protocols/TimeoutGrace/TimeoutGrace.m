...
sma = AddState(sma, 'Name', 'WaitForOdorLeft', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorState,'Condition7',SideOdorState,'Port1Out','PokeOutDetected','Condition4','PokeOutDetected'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'OdorALeft', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RewardDelayLeft','Condition4','PokeOutDetected','Port1Out','PokeOutDetected'},...
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'StateChangeConditions', {'Tup','LeftPortCheck','Condition4','PokeOutDetected','Port1Out','PokeOutDetected'},...
    'OutputActions', [{DIOmodule,SideDIOmsg2},RunOdor(LeftSideOdor,1)]);

% LEFT REWARD
sma = AddState(sma, 'Name', 'LeftPortCheck',...
    'Timer',0,...
    'StateChangeConditions',{'Condition4','LeftNotPresent','Condition1',OutcomeStateLeft,'Port1Out','LeftNotPresent'},...
    'OutputActions',{});
sma = AddState(sma, 'Name', 'LeftBigReward', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup','OutcomeDelivery','Condition4','LeftNotPresent','Port1Out','LeftNotPresent'},...
...
sma = AddState(sma, 'Name', 'WaitForOdorRight', ...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End',SideOdorState,'Condition7',SideOdorState,'Port3Out','LeavingTimeout','Condition6','LeavingTimeout'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'OdorARight', ...
    'Timer', S.GUI.OdorTime,...
    'StateChangeConditions', {'Tup','RewardDelayRight','Condition6','LeavingTimeout','Port3Out','LeavingTimeout'},...
...
sma = AddState(sma, 'Name', 'RewardDelayRight', ...
    'Timer', S.GUI.RewardDelay,...
    'StateChangeConditions', {'Tup','RightPortCheck','Condition6','LeavingTimeout','Port3Out','LeavingTimeout'},...
    'OutputActions', [{DIOmodule,SideDIOmsg2},RunOdor(RightSideOdor,2)]);

% RIGHT REWARD
sma = AddState(sma, 'Name', 'RightPortCheck',...
    'Timer',0,...
    'StateChangeConditions',{'Condition6','RightNotPresent','Condition3',OutcomeStateRight,'Port3Out','RightNotPresent'},...
    'OutputActions',{});
sma = AddState(sma, 'Name', 'RightBigReward', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup','OutcomeDelivery','Condition6','RightNotPresent','Port3Out','RightNotPresent'},...
...
sma = AddState(sma, 'Name', 'LeavingTimeout', ...
    'Timer', S.GUI.Timeout,...
...
sma = AddState(sma, 'Name', 'PokeOutDetected', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'GracePeriodState1'},...
    'OutputActions', {'GlobalTimerTrig', 10});
sma = AddState(sma, 'Name', 'GracePeriodState1', ...
    'Timer', 0.1,...
    'StateChangeConditions', {'Tup', 'GracePeriodState2', 'GlobalTimer10_End', 'LeavingTimeout', 'Port1In', 'ResetTimer'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'GracePeriodState2', ...
    'Timer', 0.1,...
    'StateChangeConditions', {'Tup', 'GracePeriodState1', 'GlobalTimer10_End', 'LeavingTimeout', 'Port1In', 'ResetTimer'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'EndTrial', ...
    ...
    'OutputActions', {'GlobalTimerCancel', 2, DIOmodule,20});
