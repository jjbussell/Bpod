...
sma = AddState(sma, 'Name', 'CenterOdor', ...
    ...
    'OutputActions',[{'BNC2',1,'DIOLicks1',CenterDIOmsg1,'PWM2',50},RunOdor(ThisCenterOdor,0)]);
sma = AddState(sma, 'Name', 'CenterOdorOff',...
    'Timer', 0,...
    'StateChangeConditions', {'Tup','WaitForCenter'},...
    'OutputActions', [{'DIOLicks1',CenterDIOmsg2,'PWM2',50},RunOdor(ThisCenterOdor,0)]);
...
sma = AddState(sma, 'Name', 'OdorALeft', ...
    ...
    'OutputActions', [{'DIOLicks1',SideDIOmsg1}, RunOdor(LeftSideOdor,1)]);
...
sma = AddState(sma, 'Name', 'RewardDelayLeft', ...
    ...
    'OutputActions', [{'DIOLicks1',SideDIOmsg2},RunOdor(LeftSideOdor,1)]);
...
sma = AddState(sma, 'Name', 'OdorARight', ...
    ...
    'OutputActions', [{'DIOLicks1',SideDIOmsg1}, RunOdor(RightSideOdor,1)]);
...
sma = AddState(sma, 'Name', 'RewardDelayRight', ...
    ...
    'OutputActions', [{'DIOLicks1',SideDIOmsg2},RunOdor(RightSideOdor,1)]);
