...
%     sma = SetGlobalCounter(sma,2,'DIO1_RightLick_Hi',S.GUI.LicksRequired);
    ...
    sma = AddState(sma, 'Name', 'RewardLeft', ...
        'Timer', LeftValveTime,...
        'StateChangeConditions', {'Tup','ResponseLeft1'},...
        'OutputActions', {'ValveState', 1});   
    sma = AddState(sma, 'Name', 'ResponseLeft1', ...
        'Timer', 0,...
        'StateChangeConditions', {'DIO1_LeftLick_Hi','ResponseLeft2'},...
        'OutputActions', {});        
    sma = AddState(sma, 'Name', 'ResponseLeft2', ...
        'Timer', 0,...
        'StateChangeConditions', {'DIO1_LeftLick_Hi','Drinking'},...
        'OutputActions', {});    

    sma = AddState(sma, 'Name', 'RewardRight', ...
        'Timer', RightValveTime,...
        'StateChangeConditions', {'Tup','ResponseRight1'},...
        'OutputActions', {'ValveState', 2});      
    sma = AddState(sma, 'Name', 'ResponseRight1', ...
        'Timer', 0,...
        'StateChangeConditions', {'DIO1_RightLick_Hi','ResponseRight2'},...
        'OutputActions', {});    
    sma = AddState(sma, 'Name', 'ResponseRight2', ...
        'Timer', 0,...
        'StateChangeConditions', {'DIO1_RightLick_Hi','Drinking'},...
        'OutputActions', {});   
