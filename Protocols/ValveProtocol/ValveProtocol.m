...
for currentTrial = 1:MaxTrials
    ...
    sma = NewStateMachine();
    sma = AddState(sma, 'Name', 'Port1', ...
        'Timer', 1,...
        'StateChangeConditions', {'Tup', 'Port3'},...
        'OutputActions', {'PWM1', 255,'ValveState',1});
    sma = AddState(sma, 'Name', 'Port3', ...
        'Timer', 1,...
        'StateChangeConditions', {'Tup', '>exit'},...
        'OutputActions', {'PWM3', 255,'ValveState',4});
