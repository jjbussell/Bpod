...
PokesPlotInfo('init', getStateColors(infoSide), getPokeColors);
...
sma = AddState(sma, 'Name', 'LeftBigReward', ...
    ...
    'OutputActions', {'GlobalTimerTrig', 3, 'GlobalTimerTrig', 2}); %, 'GlobalTimerTrig', 3
...
sma = AddState(sma, 'Name', 'RightBigReward', ...
    ...
    'OutputActions', {'GlobalTimerTrig', 4, 'GlobalTimerTrig', 2}); %, 'GlobalTimerTrig', 4
