...
// Pins 2-7 are configured as input channels, pins 7-13 are configured as output channels.
...
char moduleName[] = "Door"; // Name of module for manual override UI and state machine assembler
char* eventNames[] = {"2_Hi", "2_Lo", "3_Hi", "3_Lo", "4_Hi", "4_Lo", "5_Hi", "5_Lo", "6_Hi", "6_Lo", "7_Hi", "7_Lo"};
#define FirmwareVersion 1
#define InputOffset 2
#define OutputOffset 8
#define nInputChannels 6
#define nOutputChannels 6
