...
%}
function PokesPlotInfo(varargin)
...
%         poke_colors = varargin{3};
        ...
        BpodSystem.ProtocolFigures.PokesPlot = figure('Position', [50 50 1000 500],'name','TrialEvents','numbertitle','off', 'MenuBar', 'none', 'Resize', 'on');
...
%         BpodSystem.GUIHandles.PokesPlot.PokeColors= poke_colors;
        ...
        BpodSystem.GUIHandles.PokesPlot.RightEdge = uicontrol('Style', 'edit','String',6, 'Position', [75 10 40 20], 'FontWeight', 'normal', 'FontSize', 10, 'BackgroundColor','white', 'FontName', 'Arial','Callback', {@PokesPlot, 'time_axis'});
